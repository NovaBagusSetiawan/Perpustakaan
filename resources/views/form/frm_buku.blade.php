        ...
        <div class="fForm col-md-9">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="pengarang" class="col-sm-2 control-label"><a href="{{ url('/pengarang') }}">Pengarang <i class="fa fa-pencil"></i></a></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label for="penerbit" class="col-sm-2 control-label"><a href="{{ url('/penerbit') }}">Penerbit <i class="fa fa-print"></i></a></label>
                        <div class="col-sm-10">
                   ...
                   <div class="form-group">
                        <label for="kategori" class="col-sm-2 control-label"> <a href="{{ url('/kategori') }}">Kategori <i class="fa fa-tag"></i> </a></label>
                        <div class="col-sm-10">
