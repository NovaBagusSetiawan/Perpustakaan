...
@section('content')
    ...
    <div class="box">
        ...
        <a href="{{ url('buku/add') }}"><button class="btn btn-green btn-flat" ><i class="fa fa-book"></i> Tambah</button></a>
        <a href="{{ url('rpt/buku') }}"><button class="btn btn-green btn-flat" ><i class="fa fa-user"></i> Report Buku</button></a>
        </div>
    <!-- /.box-header -->
        <div class="box-body">
